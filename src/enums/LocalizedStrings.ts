export const LocalizedStrings = {
  "en": {
    ...
    previousDentalTreatment: "Previous Dental Treatment",
    ...
    swelling: "Swelling",
    other: "Other",
    intraOralExamination: "Intra Oral Examination",
    followup: "Follow up",
    extraOralExamination: "Extra Oral Examination",
    historyOfComplaint: "History of Complaint",
  ...
  "ar": {
    ...
    previousDentalTreatment: "جلسات طب الاسنان السابقة",
    findings: "نتائج الفحص",
    treatmentPlan: "خطة العلاج ",
    treatmentSession: "جلسة العلاج",
    recommendations: "توصيات",
    patientSnapshot: "صفحة المريض",
    lymphnodes: "الغدد الليمفاوية",
    tmj: "TMJ",
    swelling: "انتفاخ",
    other: "آخر",
    intraOralExamination: "فحص الفم",
    followup: "متابعة",
    extraOralExamination: "فحص شفوي إضافي",
    historyOfComplaint: "تاريخ الشكاوى",
    referralToSpecialist: "الإحالة إلى أخصائي",
